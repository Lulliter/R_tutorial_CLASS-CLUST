...
load(here::here( "AC_ppl_fakeID.Rdata"), verbose = F)
...
# LOAD DATA ################################################
# Read CSV 
df_big <- read.csv(here::here( "ccdefault.csv"), header = T)
...
```{r}
## ------------------------------------------------------------------------
SpamData<-read.csv(here::here( "SpamData2.csv"))
...
# LOAD DATA ################################################
# POV is where .toml is? 
states <- read.csv(here::here( "ClusterData.csv"), header = T)
